...
---
    ...
    <section id="about">
        ...
        <p>
            Mon <strong>esprit d'équipe, ma rigueur et ma discipline</strong> me permettent de m'intégrer rapidement et de mener à bien des projets ambitieux.
        </p>
    </section>
    ...
    <section id="projects">
        ...
        <div class="projects-container">
            ...
            <div class="project-card">
                <img src="image/app1.png" alt="image_1_projet_2">
            ...
            <div class="project-card">
                <img src="image/paaxio_logo_nom_down_noir.png" alt="Projet_4">
                <h3>Développement d'un site web grâce à un cahier des charges</h3>
    ...
    <section id="skills">
        ...
        <div class="skills-container">
            <div class="skill">
            <span><i class="devicon-html5-plain colored"></i> HTML / CSS <i class="devicon-css3-plain colored"></i></span>
            ...
            <div class="skill">
            <span><i class="devicon-mysql-plain colored"></i> SQL</span>
            <div class="progress-bar">
                <div class="progress" data-value="80"></div>
            </div>
            </div>
    ...
    <section id="contact">
        ...
        <div class="contact-links">
            <a href="https://github.com/ErwanH7">Vous pouvez regarder mon GitHub grâce à ce lien :</a>
        </div>
        <div class="contact-links">
            <a href="https://www.linkedin.com/in/erwan-hoarau/">Vous pouvez regarder mon LinkedIn grâce à ce lien :</a>
        </div>
        <div class="contact-links">
            <p>Ou me contacter directement via le formulaire ci-dessous :</p>
        </div>
