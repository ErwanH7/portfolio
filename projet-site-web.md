    ...
    <section id="project-detail">
        ...
        <div class="detail-content">
            ...
            <ul class = "objectives-list">
                <li>Créer un site web fonctionnel et responsive</li>
                <li>Maîtriser HTML et CSS sans outils modernes (pas de flex)</li>
                <li>Mettre en place une navigation fluide</li>
                <li>Gérer les images et l'intégration responsive</li>
            </ul>
            ...
            <ul class ="strengths-list">
                <li>Compréhension approfondie du CSS positionnement</li>
                <li>Gestion responsive sans flexbox</li>
                <li>Code structuré et respectant les bonnes pratiques de HTML</li>
            </ul>
            ...
            <div class="project-links">
                <a href="https://github.com/ErwanH7/web" class="btn-github">Voir sur GitHub</a>
            </div>
        </div>
    </section>