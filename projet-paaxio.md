...
---
    ...
    <section id="project-detail">
        ...
        <div class="detail-content">
            ...
            <p style="background: rgba(162, 90, 233, 0.1); padding: 15px; border-radius: 8px; margin: 15px 0;" class="project-status">
                <strong>Phase 1 : </strong> Cahier des charges complété et validé<br>
